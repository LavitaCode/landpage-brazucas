...
export const TEMPLATES: ChatMsgTemplate[] = [
    ...
    // ——— novo fluxo de checkout (iniciado a partir do plano selecionado)
    { id: 'checkout-intro',     text: 'Ótima escolha: plano {{plan}} ({{price}} / {{period}}). Prefere pagar agora ou falar com nosso atendimento?' },
];
